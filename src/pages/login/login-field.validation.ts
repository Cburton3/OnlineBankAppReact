import { buildRequiredFieldValidationFailedResponse, buildValidationSucceeded, isStringValueProvided } from "@/common/validations";
...
export const validateUserField = (value: string) : FieldValidationResult => {
    if(!isStringValueProvided(value)) {//checks if value empty
